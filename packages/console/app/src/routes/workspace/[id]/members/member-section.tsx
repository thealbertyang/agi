...
import type { UserRole } from '@opencode-ai/console-core/schema/user.sql.js'
		...
		<tr>
			...
			<td data-slot="member-role">
				<Show
					...
					fallback={<span>{props.member.role}</span>}
				>
					<RoleDropdown
			...
			<td data-slot="member-usage">
				<Show
					when={store.editing}
					fallback={<span>{getUsageDisplay()}</span>}
				>
					<input

			...
			<div class={styles.root}>
				<div data-component="feature-grid">
					<div data-slot="feature">
						...
						<p>
							We've benchmarked and tested models specifically for coding agents to
					...
					<div data-slot="feature">
						...
						<p>
							Access models configured for optimal performance - no downgrades or
					...
					<div data-slot="feature">
						<h3>No Lock-in</h3>
						<p>
							Use Zen with any coding agent, and continue using other providers with
							opencode whenever you want.
						</p>
					</div>
				</div>

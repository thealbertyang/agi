	...
	return (
		<section class={styles.root}>
			<div data-slot="section-title">
				<h2>Billing</h2>
				<p>
					Manage payments methods. <a href="mailto:contact@anoma.ly">Contact us</a> if you
					have any questions.
				</p>
			</div>
							...
							<Show
								...
								fallback={
									<div data-slot="add-balance-form-container">
										...
										<Show
											when={
												checkoutSubmission.result &&
												(checkoutSubmission.result as any).error
											}
										>
											{(err: any) => (
												<div data-slot="form-error">{err()}</div>
											)}
										</Show>
									</div>
								}

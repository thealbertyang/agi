		...
		<section class={styles.root}>
			<div data-slot="section-title">
				...
				<div data-slot="title-row">
					<Show
						...
						fallback={
							<p>
								Auto reload is <b>disabled</b>. Enable to automatically reload when
								balance is low.
							</p>
						}
					>
						<p>
							Auto reload is <b>enabled</b>. We'll reload{' '}
							<b>${billingInfo()?.reloadAmount}</b> (+$1.23 processing fee) when
							balance reaches <b>${billingInfo()?.reloadTrigger}</b>.
						</p>
					</Show>
					<button
						data-color="primary"
			...
			<Show when={store.show}>
				...
				>
					...
					<Show
						when={
							setReloadSubmission.result && (setReloadSubmission.result as any).error
						}
					>
					...
					<div data-slot="form-actions">
						...
						<button
							type="submit"
							data-color="primary"
							disabled={setReloadSubmission.pending}
						>
				...
				<div data-slot="section-content">
					<div data-slot="reload-error">
						<p>
							...
							. Reason: {billingInfo()?.reloadError?.replace(/\.$/, '')}. Please
						...
						>
							...
							<button
								data-color="ghost"
								type="submit"
								disabled={reloadSubmission.pending}
							>

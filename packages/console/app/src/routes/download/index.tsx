...
export default function Download() {
	...
	return (
		<main data-page="download">
			...
			<Meta
				name="description"
				content="Download OpenCode for macOS, Windows, and Linux"
			/>
				...
				<div data-component="content">
					<section data-component="download-hero">
						...
						<div data-component="hero-text">
							...
							<Show when={detectedOS()}>
								<a
									href={getDownloadHref(getDownloadPlatform(detectedOS()))}
					...
					<section data-component="download-section">
						...
						<div data-component="section-content">
							...
							<button
								data-component="cli-row"
								onClick={handleCopyClick('npm i -g opencode-ai')}
							>
								<code>
							...
							<button
								data-component="cli-row"
								onClick={handleCopyClick('bun add -g opencode-ai')}
							>
								<code>
							...
							<button
								data-component="cli-row"
								onClick={handleCopyClick('brew install opencode')}
							>
								<code>
							...
							<button
								data-component="cli-row"
								onClick={handleCopyClick('paru -S opencode')}
							>
								<code>
					...
					<section data-component="download-section">
						...
						<div data-component="section-content">
							...
							<div data-component="download-row">
								...
								<a
									href={getDownloadHref('darwin-aarch64-dmg')}
							...
							<div data-component="download-row">
								...
								<a
									href={getDownloadHref('darwin-x64-dmg')}
									data-component="action-button"
								>
									Download
								</a>
							...
							<div data-component="download-row">
								...
								<a
									href={getDownloadHref('windows-x64-nsis')}
									data-component="action-button"
								>
									Download
								</a>
							...
							<div data-component="download-row">
								...
								<a
									href={getDownloadHref('linux-x64-deb')}
									data-component="action-button"
								>
									Download
								</a>
							...
							<div data-component="download-row">
								...
								<a
									href={getDownloadHref('linux-x64-rpm')}
									data-component="action-button"
								>
									Download
								</a>
							...
							<div data-component="download-row">
								...
								<a
									href={getDownloadHref('linux-x64-appimage')}
									data-component="action-button"
								>
									Download
								</a>
					...
					<section data-component="download-section">
						...
						<div data-component="section-content">
							<div data-component="download-row">
								...
								<a
									href="https://opencode.ai/docs/github/"
									data-component="action-button"
								>
									Install
								</a>
							...
							<div data-component="download-row">
								...
								<a
									href="https://opencode.ai/docs/gitlab/"
									data-component="action-button"
								>
									Install
								</a>
					...
					<ul>
						<li>
							<Faq question="What is OpenCode?">
								OpenCode is an open source agent that helps you write and run code
								with any AI model. It's available as a terminal-based interface,
						...
						<li>
							<Faq question="Do I need extra AI subscriptions to use OpenCode?">
								Not necessarily, but probably. You'll need an AI subscription if you
								want to connect OpenCode to a paid provider, although you can work
								with{' '}
								<a
								...
								for free. While we encourage users to use <A href="/zen">Zen</A>,
								OpenCode works with all popular providers such as OpenAI, Anthropic,
								xAI etc.
							</Faq>
						</li>
						<li>
						...
						<li>
							<Faq question="How much does OpenCode cost?">
								OpenCode is 100% free to use. Any additional costs will come from
								your subscription to a model provider. While OpenCode works with any
								model provider, we recommend using <A href="/zen">Zen</A>.
							</Faq>
						</li>
						<li>
							<Faq question="What about data and privacy?">
								Your data and information is only stored when you create sharable
								links in OpenCode. Learn more about{' '}
						...
						<li>
							<Faq question="Is OpenCode open source?">
								...
								, meaning anyone can use, modify, or contribute to its development.
								Anyone from the community can file issues, submit pull requests, and

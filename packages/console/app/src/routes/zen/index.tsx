...
export default function Home() {
	...
	return (
		<main data-page="zen">
			...
			<Link
				rel="canonical"
				href={`${config.baseUrl}/zen`}
			/>
			<Meta
				property="og:image"
				content="/social-share-zen.png"
			/>
			<Meta
				name="twitter:image"
				content="/social-share-zen.png"
				...
				<div data-component="content">
					<section data-component="hero">
						<div data-slot="hero-copy">
							...
							<p>
								...
								tested and benchmarked specifically for coding agents. No need to
								worry about inconsistent performance and quality, use validated
								models that work.
							</p>
					...
					<section data-component="problem">
						<div data-slot="section-title">
							...
							<p>
								There are so many models available, but only a few work well with
						...
						<ul>
							...
							<li>
								<span>[*]</span> Working with providers to ensure they’re delivered
								properly
							</li>
							<li>
					...
					<section data-component="how">
						<div data-slot="section-title">
							<h3>How Zen works</h3>
							<p>
								While we suggest you use Zen with OpenCode, you can use Zen with any
								agent.
							</p>
						</div>
						<ul>
							...
							<li>
								...
								<div>
									...
									<a href="/docs/zen/#pricing">pay per request</a> with zero
									markups
								</div>
							</li>
							<li>
					...
					<section data-component="testimonials">
						...
						<a href="https://x.com/thdxr/status/1973531687629017227">
							<div data-slot="testimonial">
								...
								<div data-slot="quote">
									<span>@OpenCode</span> Zen has been life changing, it's truly a
									no-brainer.
								</div>
							</div>
						</a>
						...
						<a href="https://x.com/jayair/status/1973530190870618456">
							<div data-slot="testimonial">
								...
								<div data-slot="quote">
									4 out of 5 people on our team love using <span>@OpenCode</span>{' '}
									Zen.
								</div>
							</div>
						</a>
						...
						<a href="https://x.com/iamdavidhill/status/1973530568773214622">
							<div data-slot="testimonial">
								...
								<div data-slot="quote">
									With <span>@OpenCode</span> Zen I know all the models are tested
									and perfect for coding agents.
								</div>
							</div>
						</a>
						{/*Frank*/}
						...
						<ul>
							...
							<li>
								<Faq question="What makes Zen more accurate?">
									Zen only provides models that have been specifically tested and
									benchmarked for coding agents. You wouldn’t use a butter knife
							...
							<li>
								<Faq question="Is Zen cheaper?">
									...
									model providers to you. The higher Zen’s usage the more OpenCode
									can negotiate better rates and pass those to you.
								</Faq>
							</li>
							<li>
								<Faq question="How much does Zen cost?">
									Zen <a href="/docs/zen/#pricing">charges per request</a> with
									zero markups, so you pay exactly what the model provider
									charges. Your total cost depends on usage, and you can set
									monthly spend limits in your <a href="/auth">account</a>. To
									cover costs, OpenCode adds only a small payment processing fee
							...
							<li>
								<Faq question="Can I cancel?">
									Yes, you can disable billing at any time and use your remaining
									balance.
								</Faq>
							</li>
							<li>
								<Faq question="Can I use Zen with other coding agents?">
									...
									agent. Follow the setup instructions in your preferred coding
									agent.
								</Faq>
							</li>
						</ul>

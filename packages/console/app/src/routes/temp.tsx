			...
			<div data-component="content">
				...
				<section data-component="features">
					<ul data-slot="list">
						...
						<li>
							<strong>LSP enabled</strong> Automatically loads the right LSPs for the
							LLM
						</li>
						<li>
							<strong>opencode zen</strong> A{' '}
							<a href="/docs/zen">curated list of models</a> provided by opencode{' '}
							<label>New</label>
						</li>
						<li>
							<strong>Multi-session</strong> Start multiple agents in parallel on the
							same project
						</li>
						<li>
							<strong>Shareable links</strong> Share a link to any sessions for
							reference or to debug
						</li>
						<li>
							<strong>Claude Pro</strong> Log in with Anthropic to use your Claude Pro
							or Max account
						</li>
						<li>
				...
				<section data-component="screenshots">
					<figure>
						...
						<a href="/docs/cli">
							<img
								src={IMG_SPLASH}
								alt="opencode TUI with tokyonight theme"
							/>
						</a>
					</figure>
				</section>

...
export default function PrivacyPolicy() {
	return (
		<main data-page="legal">
			...
			<Link
				rel="canonical"
				href={`${config.baseUrl}/legal/privacy-policy`}
			/>
			<Meta
				name="description"
				content="OpenCode privacy policy"
			/>
				...
				<div data-component="content">
					<section data-component="brand-content">
						<article data-component="privacy-policy">
							...
							<p>
								At OpenCode, we take your privacy seriously. Please read this
								...
								<strong>
									...
									disclose your information as described in this Privacy Policy.
								</strong>
							</p>

							<p>
								Remember that your use of OpenCode is at all times subject to our
								Terms of Use,{' '}
							...
							<p>
								You may print a copy of this Privacy Policy by clicking the print
							...
							<p>
								...
								material changes by placing a notice on the OpenCode website, by
							...
							<ul>
									...
									<ul>
										...
										<li>
											<a href="#other-permitted-purposes">
												Other Permitted Purposes for Processing Personal
												Data
											</a>
										</li>
										<li>
											<a href="#categories-of-sources">
								...
								<li>
									<a href="#personal-data-of-children">
										Personal Data of Children
									</a>
								</li>
								<li>
									<a href="#california-resident-rights">
										California Resident Rights ("CCPA")
									</a>
								</li>
								<li>
									<a href="#colorado-resident-rights">
										Colorado Resident Rights ("CPA")
									</a>
								</li>
								<li>
									<a href="#connecticut-resident-rights">
										Connecticut Resident Rights ("CTDPA")
									</a>
								</li>
								<li>
									<a href="#delaware-resident-rights">
										Delaware Resident Rights ("DPDPA")
									</a>
								</li>
								<li>
									<a href="#iowa-resident-rights">
										Iowa Resident Rights ("ICDPA")
									</a>
								</li>
								<li>
									<a href="#montana-resident-rights">
										Montana Resident Rights ("MCDPA")
									</a>
								</li>
								<li>
									<a href="#nebraska-resident-rights">
								...
								<li>
									<a href="#new-jersey-resident-rights">
										New Jersey Resident Rights ("NJPA")
									</a>
								</li>
								<li>
									<a href="#oregon-resident-rights">
										Oregon Resident Rights ("OCPA")
									</a>
								</li>
								<li>
									<a href="#texas-resident-rights">
										Texas Resident Rights ("TDPSA")
									</a>
								</li>
								<li>
									<a href="#utah-resident-rights">
										Utah Resident Rights ("UCPA")
									</a>
								</li>
								<li>
									<a href="#virginia-resident-rights">
								...
								<li>
									<a href="#other-state-law-privacy-rights">
							...
							<h2 id="what-this-privacy-policy-covers">
								What this Privacy Policy Covers
							</h2>
							<p>
							...
							<h3 id="categories-of-personal-data">
								Categories of Personal Data We Collect
							</h3>
							<p>
							...
							<div class="table-wrapper">
								<table>
									...
									<tbody>
										<tr>
											<td>
												<strong>Profile or Contact Data</strong> such as
												first and last name, email, phone number and mailing
												address.
											</td>
											<td>
												<ul>
										...
										<tr>
											<td>
												<strong>Payment Data</strong> such as financial
												account information, payment card type, full number
												of payment card, last 4 digits of payment card, bank
												account information, billing address, billing phone
										...
										<tr>
											<td>
												<strong>Device/IP Data</strong> such as IP address,
												device ID, domain server, type of device/operating
										...
										<tr>
											<td>
												...
												such as information included in conversations or
												prompts that you submit to AI
											</td>
											<td>
												<ul>
													<li>
							...
							<ul>
								...
								<li>
									...
									privacy laws, such as the California Consumer Privacy Act, as
									amended by the California Privacy Rights Act of 2020 (the
									"CCPA"), the Colorado Privacy Act (the "CPA"), the Connecticut
									Data Privacy Act (the "CTDPA"), the Delaware Personal Data
									Privacy Act (the "DPDPA"), the Iowa Consumer Data Protection Act
									(the "ICDPA"), the Montana Consumer Data Privacy Act ("MCDPA"),
									the Nebraska Data Privacy Act (the "NDPA"), the New Hampshire
									Privacy Act (the "NHPA"), the New Jersey Privacy Act (the
									"NJPA"), the Oregon Consumer Privacy Act ("OCPA"), the Texas
									Data Privacy and Security Act ("TDPSA"), the Utah Consumer
									Privacy Act (the "UCPA"), or the Virginia Consumer Data
									Protection Act (the "VCDPA") (collectively, the "State Privacy
									Laws").
								</li>
							</ul>
							...
							<p>
								...
								protecting the rights, property or safety of you, OpenCode or
								another party; enforcing any agreements with you; responding to
								claims that any posting or other content violates third-party
							...
							<p>
								...
								Personal Data from children under 18 years of age; if you are a
								...
								we have collected Personal Data from a child under 18 years of age,
								we will delete that information as quickly as possible. If you
								believe that a child under 18 years of age may have provided
							...
							<p>
								...
								this section. Please see the "Exercising Your Rights under the State
								Privacy Laws" section below for instructions regarding how to
								exercise these rights. Please note that we may process Personal Data
								of our customers' end users or employees in connection with our
								...
								address your rights with respect to such data. Additionally, please
								note that these rights are subject to certain conditions and
								exceptions under applicable law, which may permit or require us to
								deny your request.
							</p>
							...
							<p>
								...
								contact us at <a href="mailto:contact@anoma.ly">contact@anoma.ly</a>
								.
							</p>
							...
							<p>
								...
								collection and use of your Personal Data. In response, we will
								provide you with the following information in the past 12 months:
							</p>
							<ul>
								<li>
							...
							<p>
								You may request the above information beyond the 12-month period,
								but no earlier than January 1, 2022. If you do make such a request,
								we are required to provide that information unless doing so proves
							...
							<p>
								...
								we have collected from you. Under the CCPA, this right is subject to
								...
								other action you have requested, or if deletion of your Personal
								Data involves disproportionate effort. If your deletion request is
								subject to one of these exceptions, we may deny your deletion
								request.
							</p>
							...
							<p>
								...
								Personal Data we have collected about you. Under the CCPA, this
							...
							<p>
								We will not sell or share your Personal Data, and have not done so
								over the last 12 months. To our knowledge, we do not sell or share
								the Personal Data of minors under 13 years of age or of consumers
								under 16 years of age.
							</p>

							<h3>Limit the Use of Sensitive Personal Information</h3>
							<p>
								Consumers have certain rights over the processing of their Sensitive
								Personal Information. However, we do not collect Sensitive Personal
								Information.
							</p>
							...
							<p>
								...
								the Colorado Privacy Act ("CPA"). Please see the "Exercising Your
								Rights under the State Privacy Laws" section below for instructions
								...
								connection with our provision of certain services to our customers.
								If we are processing your Personal Data as a service provider, you
								should contact the entity that collected your Personal Data in the
								first instance to address your rights with respect to such data.
							...
							<p>
								If there are any conflicts between this section and any other
								provision of this Privacy Policy and you are a Colorado resident,
								the portion that is more protective of Personal Data shall control
								to the extent of such conflict. If you have any questions about this
								section or whether any of the following rights apply to you, please
								contact us at <a href="mailto:contact@anoma.ly">contact@anoma.ly</a>
							...
							<p>
								...
								processing your Personal Data and to access and request a copy of
								your Personal Data in a machine-readable format, to the extent
								technically feasible, twice within a calendar year.
							</p>
							...
							<p>
								...
								nature of such data and our purposes of processing your Personal
								Data.
							</p>
							...
							<h3>Personal Data Sales Opt-Out</h3>
							<p>
								We do not currently sell or process for the purposes of targeted
								advertising your Personal Data as defined under the CPA.
							</p>

							<h3>Profiling Opt-Out</h3>
							<p>
								We do not process your Personal Data for "Profiling" to make
								"Decisions" under the CPA. "Profiling" means any form of automated
								...
								interests, reliability, behavior, location or movements. "Decision"
								means any "Decisions that produce legal or similarly significant
								effects concerning a Consumer," as defined in the CPA that concern
								you.
							</p>

							<h3>Consent or "Opt-in" Required and How to Withdraw</h3>
							<p>
								We may seek your consent to collect or process certain Personal
								Data, including: 1) Sensitive Data, 2) Personal Data from a known
								child under 13 years of age, 3) to sell, or process Personal Data
								for Targeted Advertising or Profiling after you exercise your right
								to opt-out, or 4) Personal Data for Secondary Use.
							</p>

							<p>
								If you would like to withdraw your consent, please follow the
								instructions under the "Exercising Your Rights under the State
								Privacy Laws" section.
							</p>

							<h3>We Will Not Discriminate Against You</h3>
							<p>
								We will not process your personal data in violation of state and
							...
							<p>
								If you are a Connecticut resident, you have the rights set forth
								under the Connecticut Data Privacy Act ("CTDPA"). Please see the
								"Exercising Your Rights under the State Privacy Laws" section below
								...
								such data. Additionally, please note that these rights are subject
								to certain conditions and exceptions under applicable law, which may
								permit or require us to deny your request.
							</p>

							<p>
								If there are any conflicts between this section and any other
								provision of this Privacy Policy and you are a Connecticut resident,
								the portion that is more protective of Personal Data shall control
								to the extent of such conflict. If you have any questions about this
								section or whether any of the following rights apply to you, please
								contact us at <a href="mailto:contact@anoma.ly">contact@anoma.ly</a>
							...
							<p>
								You have the right to request confirmation of whether or not we are
								processing your Personal Data and to access your Personal Data and
							...
							<p>
								...
								or we have obtained about you.
							</p>

							<h3>Personal Data Sales Opt-Out</h3>
							<p>
								We do not currently sell or process for the purposes of targeted
								advertising your Personal Data as defined under the CTDPA.
							</p>

							<h3>Profiling Opt-Out</h3>
							<p>
								We do not process your Personal Data for "Profiling" as defined
								under the CTDPA. "Profiling" means any form of automated processing
							...
							<p>
								We may seek your consent to collect or process certain Personal
								Data, including: 1) Sensitive Data, 2) Sensitive Data from a known
								child under 13 years of age, or 3) to sell, or process Personal Data
								for Targeted Advertising of a consumer at least 13 years of age but
								younger than 16 years of age.
							</p>

							<p>
								However, we currently do not collect or process your Personal Data
								as described above.
							</p>
							...
							<p>
								We will not discriminate against you for exercising your rights
								under the CTDPA. We will not deny you our goods or services, charge
								you different prices or rates, or provide you a lower quality of
								goods and services if you exercise your rights under the CTDPA.
								However, we may offer different tiers of our Services as allowed by
								applicable data privacy laws (including the CTDPA) with varying
								prices, rates or levels of quality of the goods or services you
								receive related to the value of Personal Data that we receive from
								you.
							</p>
							...
							<p>
								If you are a Delaware resident, you have the rights set forth under
								the Delaware Personal Data Privacy Act ("DPDPA"). Please see the
								"Exercising Your Rights under the State Privacy Laws" section below
								for instructions regarding how to exercise these rights. Please note
								that we may process Personal Data of our customers' end users or
								employees in connection with our provision of certain services to
							...
							<p>
								If there are any conflicts between this section and any other
								provision of this Privacy Policy and you are a Delaware resident,
								the portion that is more protective of Personal Data shall control
								to the extent of such conflict. If you have any questions about this
								section or whether any of the following rights apply to you, please
								contact us at <a href="mailto:contact@anoma.ly">contact@anoma.ly</a>
							...
							<p>
								We do not currently sell or process for the purposes of targeted
								advertising your Personal Data as defined under the DPDPA.
							</p>

							<h3>Profiling Opt-Out</h3>
							<p>
								We do not process your Personal Data for "Profiling" to make
								"Decisions" under the DPDPA. "Profiling" means any form of automated
								processing performed on personal data to evaluate, analyze or
								predict personal aspects related to an identified or identifiable
								individual's economic circumstances, health, personal preferences,
								interests, reliability, behavior, location or movements. "Decision"
								means any "Decisions that produce legal or similarly significant
								effects concerning a Consumer," as defined in the DPDPA that concern
								you. To our knowledge, we do not process the Personal Data of
								consumers under 18 years of age for the purpose of Profiling.
							</p>
							...
							<p>
								We may seek your consent to collect or process certain Personal
								Data, including: 1) Sensitive Data, 2) Sensitive Data from a known
								child under 13 years of age, 3) or to sell, or process Personal Data
								for Targeted Advertising, or Profiling of a consumer at least 13
							...
							<p>
								We will not discriminate against you for exercising your rights
								under the DPDPA. We will not deny you our goods or services, charge
								you different prices or rates, or provide you a lower quality of
								goods and services if you exercise your rights under the DPDPA.
								However, we may offer different tiers of our Services as allowed by
								applicable data privacy laws (including the DPDPA) with varying
								prices, rates or levels of quality of the goods or services you
								receive related to the value of Personal Data that we receive from
								you.
							</p>
							...
							<p>
								If you are an Iowa resident, you have the rights set forth under the
								Iowa Consumer Data Protection Act ("ICDPA"). Please see the
								"Exercising Your Rights under the State Privacy Laws" section below
								for instructions regarding how to exercise these rights. Please note
								that we may process Personal Data of our customers' end users or
								employees in connection with our provision of certain services to
							...
							<p>
								If there are any conflicts between this section and any other
								provision of this Privacy Policy and you are an Iowa resident, the
								portion that is more protective of Personal Data shall control to
							...
							<ul>
								<li>
									Targeted Advertising: We do not process your Personal Data for
									targeted advertising purposes.
								</li>
								<li>
									Sale of Personal Data: We do not currently sell your Personal
									Data as defined under the ICDPA.
								</li>
								<li>
									Processing of Sensitive Personal Data: We do not process
							...
							<p>
								We will not discriminate against you for exercising your rights
								under the ICDPA. We will not deny you our goods or services, charge
								you different prices or rates, or provide you a lower quality of
								goods and services if you exercise your rights under the ICDPA.
								However, we may offer different tiers of our Services as allowed by
								applicable data privacy laws (including the ICDPA) with varying
								prices, rates or levels of quality of the goods or services you
								receive related to the value of Personal Data that we receive from
								you.
							</p>
							...
							<p>
								If you are a Montana resident, you have the rights set forth under
								the Montana Consumer Data Privacy Act ("MCDPA"). Please see the
								"Exercising Your Rights under the State Privacy Laws" section below
								for instructions regarding how to exercise these rights. Please note
								that we may process Personal Data of our customers' end users or
								employees in connection with our provision of certain services to
							...
							<p>
								If there are any conflicts between this section and any other
								provision of this Privacy Policy and you are a Montana resident, the
								portion that is more protective of Personal Data shall control to
								the extent of such conflict. If you have any questions about this
								section or whether any of the following rights apply to you, please
								contact us at <a href="mailto:contact@anoma.ly">contact@anoma.ly</a>
							...
							<p>
								We do not currently sell or process for the purposes of targeted
								advertising your Personal Data as defined under the MCDPA.
							</p>

							<h3>Profiling Opt-Out</h3>
							<p>
								We do not process your Personal Data for "Profiling" to make
								"Decisions" under the MCDPA. "Profiling" means any form of automated
								processing performed on personal data to evaluate, analyze or
								predict personal aspects related to an identified or identifiable
								individual's economic circumstances, health, personal preferences,
								interests, reliability, behavior, location or movements. "Decision"
								means any "Decisions that produce legal or similarly significant
								effects concerning a Consumer," as defined in the MCDPA that concern
								you. To our knowledge, we do not process the Personal Data of
								consumers under 16 years of age for the purpose of Profiling.
							</p>
							...
							<p>
								We will not discriminate against you for exercising your rights
								under the MCDPA. We will not deny you our goods or services, charge
								you different prices or rates, or provide you a lower quality of
								goods and services if you exercise your rights under the MCDPA.
								However, we may offer different tiers of our Services as allowed by
								applicable data privacy laws (including the MCDPA) with varying
								prices, rates or levels of quality of the goods or services you
								receive related to the value of Personal Data that we receive from
								you.
							</p>
							...
							<p>
								If you are a Nebraska resident, you have the rights set forth under
								the Nebraska Data Privacy Act ("NDPA"). Please see the "Exercising
								Your Rights under the State Privacy Laws" section below for
								instructions regarding how to exercise these rights. Please note
								that we may process Personal Data of our customers' end users or
								employees in connection with our provision of certain services to
								our customers. If we are processing your Personal Data as a service
								provider, you should contact the entity that collected your Personal
							...
							<p>
								If there are any conflicts between this section and any other
								provision of this Privacy Policy and you are a Nebraska resident,
								the portion that is more protective of Personal Data shall control
								to the extent of such conflict. If you have any questions about this
								section or whether any of the following rights apply to you, please
								contact us at <a href="mailto:contact@anoma.ly">contact@anoma.ly</a>
							...
							<p>
								...
								processing your Personal Data and to access your Personal Data and
								request a copy of your Personal Data in a machine-readable format,
								to the extent technically feasible, twice within a calendar year.
							</p>
							...
							<p>
								We do not currently sell or process for the purposes of targeted
								advertising your Personal Data as defined under the NDPA.
							</p>

							<h3>Profiling Opt-Out</h3>
							<p>
								We do not process your Personal Data for "Profiling" to make
								"Decisions" under the NDPA. "Profiling" means any form of automated
								processing performed on personal data to evaluate, analyze or
								predict personal aspects related to an identified or identifiable
								individual's economic circumstances, health, personal preferences,
								interests, reliability, behavior, location or movements. "Decision"
								means any "Decisions that produce legal or similarly significant
								effects concerning a Consumer," as defined in the NDPA that concern
								you.
							</p>
							...
							<p>
								We may seek your consent to collect or process certain Personal
								Data, including: 1) Sensitive Data and 2) Sensitive Data from a
								known child under 13 years of age.
							</p>
							...
							<p>
								We will not discriminate against you for exercising your rights
								under the NDPA. We will not deny you our goods or services, charge
								you different prices or rates, or provide you a lower quality of
								goods and services if you exercise your rights under the NDPA.
								However, we may offer different tiers of our Services as allowed by
								applicable data privacy laws (including the NDPA) with varying
								prices, rates or levels of quality of the goods or services you
								receive related to the value of Personal Data that we receive from
								you.
							</p>

							<h2 id="new-hampshire-resident-rights">
								New Hampshire Resident Rights
							</h2>
							<p>
								If you are a New Hampshire resident, you have the rights set forth
								under the New Hampshire Privacy Act ("NHPA"). Please see the
								"Exercising Your Rights under the State Privacy Laws" section below
								for instructions regarding how to exercise these rights. Please note
								that we may process Personal Data of our customers' end users or
								employees in connection with our provision of certain services to
							...
							<p>
								If there are any conflicts between this section and any other
								provision of this Privacy Policy and you are a New Hampshire
							...
							<p>
								We do not currently sell or process for the purposes of targeted
								advertising your Personal Data as defined under the NHPA.
							</p>

							<h3>Profiling Opt-Out</h3>
							<p>
								We do not process your Personal Data for "Profiling" to make
								"Decisions" under the NHPA. "Profiling" means any form of automated
								processing performed on personal data to evaluate, analyze or
								predict personal aspects related to an identified or identifiable
								individual's economic circumstances, health, personal preferences,
								interests, reliability, behavior, location or movements. "Decision"
								means any "Decisions that produce legal or similarly significant
								effects concerning a Consumer," as defined in the NHPA that concern
								you.
							</p>
							...
							<p>
								We may seek your consent to collect or process certain Personal
								Data, including: 1) Sensitive Data and 2) Sensitive Data from a
								known child under 13 years of age, 3) or to sell or process Personal
								Data for Targeted Advertising of a consumer at least 13 years of age
							...
							<p>
								We will not discriminate against you for exercising your rights
								under the NHPA. We will not deny you our goods or services, charge
								you different prices or rates, or provide you a lower quality of
								goods and services if you exercise your rights under the NHPA.
								However, we may offer different tiers of our Services as allowed by
								applicable data privacy laws (including the NHPA) with varying
								prices, rates or levels of quality of the goods or services you
								receive related to the value of Personal Data that we receive from
								you.
							</p>
							...
							<p>
								If you are a New Jersey resident, you have the rights set forth
								under the New Jersey Privacy Act ("NJPA"). Please see the
								"Exercising Your Rights under the State Privacy Laws" section below
								for instructions regarding how to exercise these rights. Please note
								that we may process Personal Data of our customers' end users or
								employees in connection with our provision of certain services to
							...
							<p>
								If there are any conflicts between this section and any other
								provision of this Privacy Policy and you are a New Jersey resident,
								the portion that is more protective of Personal Data shall control
								to the extent of such conflict. If you have any questions about this
								section or whether any of the following rights apply to you, please
								contact us at <a href="mailto:contact@anoma.ly">contact@anoma.ly</a>
							...
							<p>
								We do not currently sell or process for the purposes of targeted
								advertising your Personal Data as defined under the NJPA.
							</p>

							<h3>Profiling Opt-Out</h3>
							<p>
								We do not process your Personal Data for "Profiling" to make
								"Decisions" under the NJPA. "Profiling" means any form of automated
								processing performed on personal data to evaluate, analyze or
								predict personal aspects related to an identified or identifiable
								individual's economic circumstances, health, personal preferences,
								interests, reliability, behavior, location or movements. "Decision"
								means any "Decisions that produce legal or similarly significant
								effects concerning a Consumer," as defined in the NJPA that concern
								you. To our knowledge, we do not process the Personal Data of
								consumers under 17 years of age for the purpose of Profiling.
							</p>
							...
							<p>
								...
								child under 13 years of age, 3) or to sell, or process Personal Data
								for Targeted Advertising, or Profiling of a consumer at least 13
								years of age but younger than 17 years of age.
							</p>
							...
							<p>
								We will not discriminate against you for exercising your rights
								under the NJPA. We will not deny you our goods or services, charge
								you different prices or rates, or provide you a lower quality of
								goods and services if you exercise your rights under the NJPA.
								However, we may offer different tiers of our Services as allowed by
								applicable data privacy laws (including the NJPA) with varying
								prices, rates or levels of quality of the goods or services you
								receive related to the value of Personal Data that we receive from
								you.
							</p>
							...
							<p>
								If you are an Oregon resident, you have the rights set forth under
								the Oregon Consumer Privacy Act ("OCPA"). Please see the "Exercising
								Your Rights under the State Privacy Laws" section below for
								instructions regarding how to exercise these rights. Please note
								that we may process Personal Data of our customers' end users or
								employees in connection with our provision of certain services to
							...
							<p>
								If there are any conflicts between this section and any other
								provision of this Privacy Policy and you are an Oregon resident, the
								portion that is more protective of Personal Data shall control to
								the extent of such conflict. If you have any questions about this
								section or whether any of the following rights apply to you, please
								contact us at <a href="mailto:contact@anoma.ly">contact@anoma.ly</a>
							...
							<p>
								You have the right to request confirmation of whether or not we are
								processing your Personal Data and to access and request a copy of
								your Personal Data, including a list of specific third parties,
								other than natural persons, to which we have disclosed your Personal
								Data or any Personal Data, in a machine-readable format, to the
							...
							<p>
								We do not currently sell or process for the purposes of targeted
								advertising your Personal Data as defined under the OCPA.
							</p>

							<h3>Profiling Opt-Out</h3>
							<p>
								We do not process your Personal Data for "Profiling" to make
								"Decisions" under the OCPA. "Profiling" means any form of automated
								processing performed on personal data to evaluate, analyze or
								predict personal aspects related to an identified or identifiable
								individual's economic circumstances, health, personal preferences,
								interests, reliability, behavior, location or movements. "Decision"
								means any "Decisions that produce legal or similarly significant
								effects concerning a Consumer," as defined in the OCPA that concern
								you. To our knowledge, we do not process the Personal Data of
								consumers under 16 years of age for the purpose of Profiling.
							</p>
							...
							<p>
								We will not discriminate against you for exercising your rights
								under the OCPA. We will not deny you our goods or services, charge
								you different prices or rates, or provide you a lower quality of
								goods and services if you exercise your rights under the OCPA.
								However, we may offer different tiers of our Services as allowed by
								applicable data privacy laws (including the OCPA) with varying
								prices, rates or levels of quality of the goods or services you
								receive related to the value of Personal Data that we receive from
								you.
							</p>
							...
							<p>
								If you are a Texas resident, you have the rights set forth under the
								Texas Data Privacy and Security Act ("TDPSA"). Please see the
								"Exercising Your Rights under the State Privacy Laws" section below
								for instructions regarding how to exercise these rights. Please note
								that we may process Personal Data of our customers' end users or
								employees in connection with our provision of certain services to
							...
							<p>
								If there are any conflicts between this section and any other
								provision of this Privacy Policy and you are a Texas resident, the
								portion that is more protective of Personal Data shall control to
								the extent of such conflict. If you have any questions about this
								section or whether any of the following rights apply to you, please
								contact us at <a href="mailto:contact@anoma.ly">contact@anoma.ly</a>
							...
							<p>
								We do not currently sell or process for the purposes of targeted
								advertising your Personal Data as defined under the TDPSA.
							</p>

							<h3>Profiling Opt-Out</h3>
							<p>
								We do not process your Personal Data for "Profiling" as defined
								under the TDPSA. "Profiling" means any form of solely automated
								processing performed on personal data to evaluate, analyze, or
								predict personal aspects related to an identified or identifiable
								individual's economic situation, health, personal preferences,
							...
							<p>
								We may seek your consent to collect or process certain Personal
								Data, including: 1) Sensitive Data, or 2) Sensitive Data from a
								known child under 13 years of age.
							</p>
							...
							<p>
								We will not discriminate against you for exercising your rights
								under the TDPSA. We will not deny you our goods or services, charge
								you different prices or rates, or provide you a lower quality of
								goods and services if you exercise your rights under the TDPSA.
								However, we may offer different tiers of our Services as allowed by
								applicable data privacy laws (including the TDPSA) with varying
								prices, rates or levels of quality of the goods or services you
								receive related to the value of Personal Data that we receive from
								you.
							</p>
							...
							<p>
								If you are a Utah resident, you have the rights set forth under the
								Utah Consumer Privacy Act ("UCPA"). Please see the "Exercising Your
								Rights under the State Privacy Laws" section below for instructions
								regarding how to exercise these rights. Please note that we may
								process Personal Data of our customers' end users or employees in
								connection with our provision of certain services to our customers.
							...
							<p>
								If there are any conflicts between this section and any other
								provision of this Privacy Policy and you are a Utah resident, the
								portion that is more protective of Personal Data shall control to
								the extent of such conflict. If you have any questions about this
								section or whether any of the following rights apply to you, please
								contact us at contact@anoma.ly.
							</p>
							...
							<h3>Deletion</h3>
							<p>
								You have the right to delete Personal Data that you have provided to
								us.
							</p>
							...
							<ul>
								...
								<li>
									Sale of Personal Data: We do not currently sell your Personal
									Data as defined under the UCPA.
								</li>
								<li>
									Processing of Sensitive Personal Data: We do not process
									Sensitive Personal Data.
							...
							<p>
								We will not discriminate against you for exercising your rights
								under the UCPA. We will not deny you our goods or services, charge
								you different prices or rates, or provide you a lower quality of
								goods and services if you exercise your rights under the UCPA.
								However, we may offer different tiers of our Services as allowed by
								applicable data privacy laws (including the UCPA) with varying
								prices, rates or levels of quality of the goods or services you
								receive related to the value of Personal Data that we receive from
								you.
							</p>
							...
							<p>
								If there are any conflicts between this section and any other
								provision of this Privacy Policy and you are a Virginia resident,
								the portion that is more protective of Personal Data shall control
								to the extent of such conflict. If you have any questions about this
								section or whether any of the following rights apply to you, please
								contact us at <a href="mailto:contact@anoma.ly">contact@anoma.ly</a>
							...
							<p>
								However, we currently do not collect or process Personal data as
								described above.
							</p>
							...
							<ul>
								...
								<li>
									Sale of Personal Data: We do not currently sell your Personal
									Data as defined under the VDCPA.
								</li>
								<li>
									Processing for Profiling Purposes: We do not currently process
									your Personal Data for the purposes of profiling.
								</li>
							</ul>

							<p>
								To exercise any of your rights for these certain processing
								activities, please follow the instructions under the "Exercising
								Your Rights under the State Privacy Laws" section.
							</p>
							...
							<p>
								We will not discriminate against you for exercising your rights
								under the VCDPA. We will not deny you our goods or services, charge
								you different prices or rates, or provide you a lower quality of
								goods and services if you exercise your rights under the VCDPA.
								However, we may offer different tiers of our Services as allowed by
								applicable data privacy laws (including the VCDPA) with varying
								prices, rates or levels of quality of the goods or services you
								receive related to the value of Personal Data that we receive from
								you.
							</p>
							...
							<p>
								...
								you are a California, Colorado, Connecticut, Delaware, Montana,
								Nebraska, New Hampshire, New Jersey, Oregon or Texas resident, your
								Authorized Agent (defined below) must send us a request that (1)
								provides sufficient information to allow us to verify that you are
								the person about whom we have collected Personal Data, and (2)
								describes your request in sufficient detail to allow us to
							...
							<p>
								...
								required by applicable law. We will not charge you a fee for making
								a Valid Request unless your Valid Request(s) is excessive,
								repetitive or manifestly unfounded. If we determine that your Valid
								Request warrants a fee, we will notify you of the fee and explain
								that decision before completing your request.
							</p>

							<h3>Request to Withdraw Consent to Certain Processing Activities</h3>
							<p>
								If you are a California resident, you may withdraw your consent
								allowing us: 1) to sell or share your Personal Data, by using the
								following method:
							</p>
							<ul>
								<li>
							...
							<p>
								You may submit a Valid Request for any other rights afforded to you
								in this Privacy Policy by using the following methods:
							</p>
							<ul>
								<li>
									Email us at{' '}
							...
							<p>
								If you are a California, Colorado, Connecticut, Delaware, Montana,
								Nebraska, New Hampshire, New Jersey, Oregon or Texas resident, you
								may also authorize an agent (an "Authorized Agent") to exercise your
								rights on your behalf. To do this, you must provide your Authorized
								Agent with written permission to exercise your rights on your
								behalf, and we may request a copy of this written permission from
								your Authorized Agent when they make a request on your behalf.
							</p>

							<h3>Appealing a Denial</h3>
							<p>
								If you are a Colorado, Connecticut, Delaware, Iowa, Montana,
								Nebraska, New Hampshire, New Jersey, Oregon, Texas or Virginia
								resident and we refuse to take action on your request within a
								reasonable period of time after receiving your request in accordance
								with this section, you may appeal our decision. In such appeal, you
								must (1) provide sufficient information to allow us to verify that
								you are the person about whom the original request pertains and to
								identify the original request, and (2) provide a description of the
								basis of your appeal. Please note that your appeal will be subject
								to your rights and obligations afforded to you under the State
								Privacy Laws (as applicable). We will respond to your appeal within
								the time period required under the applicable law. You can submit a
								Verified Request to appeal by the following methods:
							</p>
							<ul>
								<li>
									Email us at{' '}
							...
							<p>
								If we deny your appeal, you have the right to contact the Attorney
								General of your State, including by the following links: Colorado,
								Connecticut, Delaware, Iowa, Montana, Nebraska, New Hampshire, New
								Jersey, Oregon, Texas and Virginia.
							</p>

							<h2 id="other-state-law-privacy-rights">
								Other State Law Privacy Rights
							</h2>

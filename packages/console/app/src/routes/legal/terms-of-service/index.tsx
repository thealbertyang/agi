...
export default function TermsOfService() {
	return (
		<main data-page="legal">
			...
			<Link
				rel="canonical"
				href={`${config.baseUrl}/legal/terms-of-service`}
			/>
			<Meta
				name="description"
				content="OpenCode terms of service"
			/>
				...
				<div data-component="content">
					<section data-component="brand-content">
						<article data-component="terms-of-service">
							...
							<p>
								Welcome to OpenCode. Please read on to learn the rules and
								restrictions that govern your use of OpenCode (the "Services"). If
								you have any questions, comments, or concerns regarding these terms
							...
							<p>
								...
								and <strong>ANOMALY INNOVATIONS, INC.</strong> ("OpenCode," "we" and
								"us"). Your use of the Services in any way means that you agree to
							...
							<p>
								...
								bill you. These Terms include information about{' '}
								<a href="#will-these-terms-ever-change">
								...
								<strong>
									...
									SUBJECT TO THE FOLLOWING TERMS; IF YOU DO NOT AGREE TO ALL OF
							...
							<p>
								OpenCode is an AI-powered coding agent that helps you write,
								understand, and modify code using large language models. Certain of
								these large language models are provided by third parties ("Third
								Party Models") and certain of these models are provided directly by
								us if you use the OpenCode Zen paid offering ("Zen"). Regardless of
								whether you use Third Party Models or Zen, OpenCode enables you to
								access the functionality of models through a coding agent running
							...
							<p>
								...
								on our site located at opencode.ai, send you an email, and/or notify
							...
							<p>
								OpenCode takes the privacy of its users very seriously. For the
								current OpenCode Privacy Policy, please click here{' '}
							...
							<p>
								...
								behalf of or for the benefit of any third party, and only in a
								manner that complies with all laws that apply to you. If your use of
								the Services is prohibited by applicable laws, then you aren't
							...
							<ol style="list-style-type: lower-alpha;">
								...
								<li>
									uses Output to develop artificial intelligence models that
									compete with the Services or any Third Party Models;
								</li>
								<li>
							...
							<h2 id="who-owns-the-services-and-content">
								Who Owns the Services and Content?
							</h2>

							<h3>Our IP</h3>
							<p>
								We retain all right, title and interest in and to the Services.
								Except as expressly set forth herein, no rights to the Services or
								Third Party Models are granted to you.
							</p>

							<h3>Your IP</h3>
							<p>
								You may provide input to the Services ("Input"), and receive output
								from the Services based on the Input ("Output"). Input and Output
								are collectively "Content." You are responsible for Content,
								including ensuring that it does not violate any applicable law or
								these Terms. You represent and warrant that you have all rights,
								licenses, and permissions needed to provide Input to our Services.
							</p>

							<p>
								As between you and us, and to the extent permitted by applicable
							...
							<p>
								...
								extend to other users' output.
							</p>

							<p>
								We use Content to provide our Services, comply with applicable law,
								enforce our terms and policies, and keep our Services safe. In
								addition, if you are using the Services through an unpaid account,
								we may use Content to further develop and improve our Services.
							</p>

							<p>
								If you use OpenCode with Third Party Models, then your Content will
								be subject to the data retention policies of the providers of such
								Third Party Models. Although we will not retain your Content, we
								cannot and do not control the retention practices of Third Party
								Model providers. You should review the terms and conditions
								applicable to any Third Party Model for more information about the
								data use and retention policies applicable to such Third Party
								Models.
							</p>

							<h2 id="what-about-third-party-models">
								What about Third Party Models?
							</h2>
							<p>
								The Services enable you to access and use Third Party Models, which
								are not owned or controlled by OpenCode. Your ability to access
								Third Party Models is contingent on you having API keys or otherwise
								having the right to access such Third Party Models.
							</p>

							<p>
								OpenCode has no control over, and assumes no responsibility for, the
								content, accuracy, privacy policies, or practices of any providers
								of Third Party Models. We encourage you to read the terms and
								conditions and privacy policy of each provider of a Third Party
								Model that you choose to utilize. By using the Services, you release
								and hold us harmless from any and all liability arising from your
								use of any Third Party Model.
							</p>
							...
							<h2 id="do-the-services-cost-anything">
							...
							<p>
								...
								all applicable fees for such Services. Any and all such charges,
								fees or costs are your sole responsibility. You should consult with
								your
							</p>

							<h3>Paid Services</h3>
							<p>
								Certain of our Services, including Zen, may be subject to payments
								now or in the future (the "Paid Services"). Please see our Paid
								Services page <a href="/zen">https://opencode.ai/zen</a> for a
								description of the current Paid Services. Please note that any
								payment terms presented to you in the process of using or signing up
							...
							<p>
								...
								privacy policies of the Payment Processor in addition to these
								Terms. Currently, we use Stripe, Inc. as our Payment Processor. You
							...
							<p>
								The terms of your payment will be based on your Payment Method and
								may be determined by agreements between you and the financial
							...
							<p>
								...
								charges as agreed to by you. By choosing a recurring payment plan,
								you acknowledge that such Services have an initial and recurring
								...
								SUCH NOTICE WILL NOT AFFECT CHARGES SUBMITTED BEFORE WE REASONABLY
							...
							<p>
								Any free trial or other promotion that provides access to a Paid
								...
								order to avoid being charged for that Paid Service. If you cancel
								prior to the end of the trial period and are inadvertently charged
								for a Paid Service, please contact us at{' '}
								<a href="mailto:contact@anoma.ly">contact@anoma.ly</a>.
							</p>

							<h2 id="what-if-i-want-to-stop">
							...
							<p>
								OpenCode is also free to terminate (or suspend access to) your use
								of the Services for any reason in our discretion, including your
								breach of these Terms. OpenCode has the sole right to decide whether
								you are in violation of any of the restrictions set forth in these
								Terms.
							</p>
							...
							<p>
								OpenCode and its licensors, suppliers, partners, parent,
								...
								successors and assigns (OpenCode and all such parties together, the
								"OpenCode Parties") make no representations or warranties concerning
								the Services, including without limitation regarding any Content
								contained in or accessed through the Services, and the OpenCode
								...
								Services. The OpenCode Parties make no representations or warranties
								...
								SERVICES AND CONTENT ARE PROVIDED BY OPENCODE (AND ITS LICENSORS AND
							...
							<p>
								...
								ANY OF THE OPENCODE PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON
								...
								DOLLARS OR (II) THE AMOUNTS PAID AND/OR PAYABLE BY YOU TO OPENCODE
							...
							<h3>Indemnity</h3>
							<p>
								You agree to indemnify and hold the OpenCode Parties harmless from
								...
								your use of the Services, and (b) your violation of these Terms. In
							...
							<p>
								...
								operation of law or otherwise) without OpenCode's prior written
							...
							<p>
								...
								of Delaware, without regard to the conflicts of laws provisions
								thereof.
							</p>
							...
							<p>
								...
								requires you to arbitrate certain disputes and claims with OpenCode
								and limits the manner in which you can seek relief from OpenCode.
								Both you and OpenCode acknowledge and agree that for the purposes of
								any dispute arising out of or relating to the subject matter of
								these Terms, OpenCode's officers, directors, employees and
								independent contractors ("Personnel") are third-party beneficiaries
								of these Terms, and that upon your acceptance of these Terms,
								Personnel will have the right (and will be deemed to have accepted
								the right) to enforce these Terms against you as the third-party
								beneficiary hereof.
							</p>
							...
							<p>
								...
								Castle County, Delaware. The arbitration will proceed in the English
							...
							<p>
								...
								($75,000) dollars. OpenCode will not seek its attorneys' fees and
							...
							<p>
								Either you or OpenCode may assert claims, if they qualify, in small
								claims court in New Castle County, Delaware or any United States
							...
							<p>
								YOU AND OPENCODE WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO
								TO COURT AND HAVE A TRIAL IN FRONT OF A JUDGE OR JURY. You and
								OpenCode are instead choosing to have claims and disputes resolved
								...
								between you and OpenCode over whether to vacate or enforce an
								arbitration award, YOU AND OPENCODE WAIVE ALL RIGHTS TO A JURY
							...
							<p>
								...
								nor OpenCode is entitled to arbitration; instead all claims and
							...
							<p>
								...
								address: [ADDRESS], [CITY], Canada [ZIP CODE] postmarked within
								thirty (30) days of first accepting these Terms. You must include
								(i) your name and residence address, (ii) the email address and/or
							...
							<p>
								...
								OpenCode to litigate any dispute arising out of or relating to the
								...
								and OpenCode agree that any judicial proceeding (other than small
								claims actions) will be brought in the state or federal courts
								located in, respectively, New Castle County, Delaware, or the
							...
							<p>
								...
								provided that the OpenCode may, in its sole discretion, do any of
								...
								in full force and effect and enforceable. You and OpenCode agree
								that these Terms are the complete and exclusive statement of the
								mutual understanding between you and OpenCode, and that these Terms
								...
								not an employee, agent, partner, or joint venture of OpenCode, and
								you do not have any authority of any kind to bind OpenCode in any
								respect whatsoever.
							</p>

							<p>
								Except as expressly set forth in the section above regarding the
								arbitration agreement, you and OpenCode agree there are no

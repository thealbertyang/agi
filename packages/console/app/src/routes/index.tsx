				...
				<div data-component="content">
					<section data-component="hero">
						<div data-component="desktop-app-banner">
							...
							<div data-slot="content">
								<span data-slot="text">
									...
									<span data-slot="platforms"> on macOS, Windows, and Linux</span>
									.
								</span>
								<a
									href="/download"
						...
						<div data-slot="hero-copy">
							...
							<p>
								...
								<span data-slot="br"></span>including Claude, GPT, Gemini and more.
							</p>
						</div>
					...
					<section data-component="what">
						...
						<ul>
							<li>
								<span>[*]</span>
								<div>
									<strong>LSP enabled</strong> Automatically loads the right LSPs
									for the LLM
								</div>
							</li>
							<li>
							...
							<li>
								<span>[*]</span>
								<div>
									<strong>Any model</strong> 75+ LLM providers through Models.dev,
							...
							<li>
								<span>[*]</span>
								<div>
									<strong>Any editor</strong> Available as a terminal interface,
					...
					<section data-component="growth">
						<div data-slot="section-title">
							...
							<div>
								<span>[*]</span>
								<p>
									With over <strong>{config.github.starsFormatted.full}</strong>{' '}
									GitHub stars, <strong>{config.stats.contributors}</strong>{' '}
									contributors, and over <strong>{config.stats.commits}</strong>{' '}
									commits, OpenCode is used and trusted by over{' '}
									<strong>{config.stats.monthlyUsers}</strong> developers every
									month.
								</p>
							</div>
							...
							<div data-component="growth-stats">
								...
								<div data-component="growth-stat">
									...
									<span>
										<figure>Fig 2.</figure>{' '}
										<strong>{config.stats.contributors}</strong> Contributors
									</span>
								</div>
								...
								<div data-component="growth-stat">
									<div data-component="stat-illustration">
										...
										>
											<g opacity="0.5">
												<path
													d="M205 0H203.985V264H205V0Z"
													fill="#8E8B8B"
												/>
												<path
													d="M197.896 34H196.881V264H197.896V34Z"
													fill="#8E8B8B"
												/>
												<path
													d="M189.777 26H188.762V264H189.777V26Z"
													fill="#8E8B8B"
												/>
												<path
													d="M183.688 52H182.673V264H183.688V52Z"
													fill="#8E8B8B"
												/>
												<path
													d="M176.584 0H175.569V264H176.584V0Z"
													fill="#8E8B8B"
												/>
												<path
													d="M169.48 29H168.465V264H169.48V29Z"
													fill="#8E8B8B"
												/>
												<path
													d="M162.376 44H161.361V264H162.376V44Z"
													fill="#8E8B8B"
												/>
												<path
													d="M155.272 65H154.257V264H155.272V65Z"
													fill="#8E8B8B"
												/>
												<path
													d="M149.183 29H148.168V264H149.183V29Z"
													fill="#8E8B8B"
												/>
												<path
													d="M142.079 36H141.064V264H142.079V36Z"
													fill="#8E8B8B"
												/>
												<path
													d="M134.975 48H133.96V264H134.975V48Z"
													fill="#8E8B8B"
												/>
												<path
													d="M127.871 7H126.856V264H127.871V7Z"
													fill="#8E8B8B"
												/>
												<path
													d="M120.767 0H119.752V264H120.767V0Z"
													fill="#8E8B8B"
												/>
												<path
													d="M113.663 14H112.649V264H113.663V14Z"
													fill="#8E8B8B"
												/>
												<path
													d="M106.559 27H105.545V264H106.559V27Z"
													fill="#8E8B8B"
												/>
												<path
													d="M99.4554 70H98.4406V264H99.4554V70Z"
													fill="#8E8B8B"
												/>
												<path
													d="M92.3515 32H91.3366V264H92.3515V32Z"
													fill="#8E8B8B"
												/>
												<path
													d="M85.2475 35H84.2327V264H85.2475V35Z"
													fill="#8E8B8B"
												/>
												<path
													d="M78.1436 36H77.1287V264H78.1436V36Z"
													fill="#8E8B8B"
												/>
												<path
													d="M71.0396 10H70.0248V264H71.0396V10Z"
													fill="#8E8B8B"
												/>
												<path
													d="M63.9356 42H62.9208V264H63.9356V42Z"
													fill="#8E8B8B"
												/>
												<path
													d="M56.8317 43H55.8168V264H56.8317V43Z"
													fill="#8E8B8B"
												/>
												<path
													d="M49.7277 38H48.7129V264H49.7277V38Z"
													fill="#8E8B8B"
												/>
												<path
													d="M42.6238 56H41.6089V264H42.6238V56Z"
													fill="#8E8B8B"
												/>
												<path
													d="M36.5347 36H35.5198V264H36.5347V36Z"
													fill="#8E8B8B"
												/>
												<path
													d="M29.4307 8H28.4158V264H29.4307V8Z"
													fill="#8E8B8B"
												/>
												<path
													d="M22.3267 20H21.3119V264H22.3267V20Z"
													fill="#8E8B8B"
												/>
												<path
													d="M15.2228 1H14.2079V264H15.2228V1Z"
													fill="#8E8B8B"
												/>
												<path
													d="M8.11881 9H7.10396V264H8.11881V9Z"
													fill="#8E8B8B"
												/>
												<path
													d="M1.01485 31H0V264H1.01485V31Z"
													fill="#8E8B8B"
												/>
											</g>
										</svg>
									...
									<span>
										<figure>Fig 3.</figure>{' '}
										<strong>{config.stats.monthlyUsers}</strong> Monthly Devs
									</span>
								</div>
							</div>
						</div>
						...
						<div data-slot="privacy-title">
							...
							<div>
								...
								<p>
									...
									more about <a href="/docs/enterprise/ ">privacy</a>.
								</p>
							</div>
						</div>
					</section>
						...
						<ul>
							<li>
								<Faq question="What is OpenCode?">
									...
									code with any AI model. It's available as a terminal-based
							...
							<li>
								<Faq question="Do I need extra AI subscriptions to use OpenCode?">
									Not necessarily, OpenCode comes with a set of free models that
									you can use without creating an account. Aside from these, you
									can use any of the popular coding models by creating a{' '}
									<A href="/zen">Zen</A> account. While we encourage users to use
									Zen, OpenCode also works with all popular providers such as
									OpenAI, Anthropic, xAI etc. You can even connect your{' '}
									<a
										href="/docs/providers/#lm-studio"
										target="_blank"
									>
										local models
									</a>
							...
							<li>
								<Faq question="Can I use my existing AI subscriptions with OpenCode?">
									Yes, OpenCode supports subscription plans from all major
									providers. You can use your Claude Pro/Max, ChatGPT Plus/Pro, or
							...
							<li>
								<Faq question="Can I only use OpenCode in the terminal?">
									Not anymore! OpenCode is now available as an app for your
									desktop.
								</Faq>
							</li>
							<li>
								<Faq question="How much does OpenCode cost?">
									OpenCode is 100% free to use. It also comes with a set of free
									models. There might be additional costs if you connect any other
									provider.
								</Faq>
							</li>
							<li>
								<Faq question="What about data and privacy?">
									Your data and information is only stored when you use our free
									models or create sharable links. Learn more about{' '}
									<a href="/docs/zen/#privacy">our models</a> and{' '}
							...
							<li>
								<Faq question="Is OpenCode open source?">
									...
									under the{' '}
									<a
										href={`${config.github.repoUrl}?tab=MIT-1-ov-file#readme`}
										target="_blank"
									>
										MIT License
									</a>
									, meaning anyone can use, modify, or contribute to its
									development. Anyone from the community can file issues, submit
									pull requests, and extend functionality.
								</Faq>
							</li>
						</ul>
					</section>
					...
					<section data-component="zen-cta">
						<div data-slot="zen-cta-copy">
							...
							<p>
								Zen gives you access to a handpicked set of AI models that OpenCode
								has tested and benchmarked specifically for coding agents. No need
								to worry about inconsistent performance and quality across

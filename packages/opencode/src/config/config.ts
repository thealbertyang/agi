	...
	export const Keybinds = z
		.object({
			...
			scrollbar_toggle: z
				...
				.optional()
				.default('none')
				.describe('Toggle session scrollbar'),
			username_toggle: z
				.string()
				.optional()
				.default('none')
				.describe('Toggle username visibility'),
			...
			session_fork: z
				...
				.optional()
				.default('none')
				.describe('Fork session from message'),
			...
			messages_last_user: z
				.string()
				.optional()
				.default('none')
				.describe('Navigate to last user message'),
			...
			tool_details: z
				...
				.optional()
				.default('none')
				.describe('Toggle tool details visibility'),
			model_list: z
				.string()
				.optional()
				.default('<leader>m')
			...
			model_cycle_favorite: z
				.string()
				.optional()
				.default('none')
				.describe('Next favorite model'),
			model_cycle_favorite_reverse: z
				.string()
				.optional()
				.default('none')
				.describe('Previous favorite model'),
			command_list: z
				.string()
				.optional()
				.default('ctrl+p')
			...
			input_move_left: z
				...
				.optional()
				.default('left,ctrl+b')
				.describe('Move cursor left in input'),
			input_move_right: z
				.string()
				.optional()
				.default('right,ctrl+f')
				.describe('Move cursor right in input'),
			input_move_up: z.string().optional().default('up').describe('Move cursor up in input'),
			input_move_down: z
				.string()
				.optional()
				.default('down')
				.describe('Move cursor down in input'),
			input_select_left: z
				.string()
				.optional()
				.default('shift+left')
				.describe('Select left in input'),
			input_select_right: z
				.string()
				.optional()
				.default('shift+right')
				.describe('Select right in input'),
			input_select_up: z
				.string()
				.optional()
				.default('shift+up')
				.describe('Select up in input'),
			input_select_down: z
				.string()
				.optional()
				.default('shift+down')
				.describe('Select down in input'),
			input_line_home: z
				.string()
				.optional()
				.default('ctrl+a')
				.describe('Move to start of line in input'),
			input_line_end: z
				.string()
				.optional()
				.default('ctrl+e')
				.describe('Move to end of line in input'),
			...
			input_buffer_home: z
				...
				.optional()
				.default('home')
				.describe('Move to start of buffer in input'),
			input_buffer_end: z
				.string()
				.optional()
				.default('end')
				.describe('Move to end of buffer in input'),
			...
			session_parent: z
				...
				.optional()
				.default('<leader>up')
				.describe('Go to parent session'),
			terminal_suspend: z.string().optional().default('ctrl+z').describe('Suspend terminal'),
			terminal_title_toggle: z
				.string()
				.optional()
				.default('none')
				.describe('Toggle terminal title'),
			tips_toggle: z
				.string()
				.optional()
				.default('<leader>h')
				.describe('Toggle tips on home screen'),
		})
		.strict()
		.meta({
			ref: 'KeybindsConfig',

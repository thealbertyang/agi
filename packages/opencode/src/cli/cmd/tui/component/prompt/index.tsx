...
import { t, dim, fg, type KeyBinding } from '@opentui/core'
...
export function Prompt(props: PromptProps) {
	...
	async function submit() {
		...
		const allExtmarks = input.extmarks.getAllForTypeId(promptPartTypeId)
		const sortedExtmarks = allExtmarks.toSorted(
							...
							<Switch>
								<Match when={store.mode === 'normal'}>
									<text fg={theme.text}>
										...
										<span style={{ fg: theme.textMuted }}>switch agent</span>
									</text>
									<text fg={theme.text}>

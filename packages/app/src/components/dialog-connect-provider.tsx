									...
									<div class="flex flex-col gap-6">
										<Switch>
											<Match when={provider().id === 'opencode'}>
												<div class="flex flex-col gap-4">
													<div class="text-14-regular text-text-base">
														OpenCode Zen gives you access to a curated
														set of reliable optimized models for coding
														agents.
													</div>
													<div class="text-14-regular text-text-base">
														With a single API key you'll get access to
														models such as Claude, GPT, Gemini, GLM and
														more.
													</div>
													<div class="text-14-regular text-text-base">
														Visit{' '}
											...
											<Match when={true}>
												<div class="text-14-regular text-text-base">
													...
													your account and use {provider().name} models in
													OpenCode.
												</div>
											</Match>
										</Switch>
										...
										>
											<TextField
												...
												validationState={
													formStore.error ? 'invalid' : undefined
												}
							...
							<Switch>
								<Match when={store.authorization?.method === 'code'}>
									{iife(() => {
										...
										onMount(() => {
											if (
												store.authorization?.method === 'code' &&
										...
										return (
											<div class="flex flex-col gap-6">
												<div class="text-14-regular text-text-base">
													...
													to collect your authorization code to connect
													your account and use {provider().name} models in
													OpenCode.
												</div>
												<form
										...
										return (
											<div class="flex flex-col gap-6">
												<div class="text-14-regular text-text-base">
													...
													and enter the code below to connect your account
													and use {provider().name} models in OpenCode.
												</div>
												<TextField

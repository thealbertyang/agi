			...
			<div data-component="decoration">
				...
				>
					...
					>
						<Switch>
							<Match
								when={props.message.role === 'user' && props.part.type === 'text'}
							>
								<IconUserCircle
									width={18}
									height={18}
							...
							<Match
								when={props.message.role === 'user' && props.part.type === 'file'}
							>
								<IconPaperClip
									width={18}
									height={18}
							...
							<Match
								when={props.part.type === 'tool' && props.part.tool === 'todowrite'}
							>
								<IconQueueList
									width={18}
									height={18}
							...
							<Match
								when={props.part.type === 'tool' && props.part.tool === 'todoread'}
							>
								<IconQueueList
									width={18}
									height={18}
							...
							<Match
								when={props.part.type === 'tool' && props.part.tool === 'webfetch'}
							>
								<IconGlobeAlt
									width={18}
									height={18}
	...
	return (
		<>
			...
			<div data-component="tool-result">
				<Switch>
					<Match
						when={props.state.metadata?.matches && props.state.metadata?.matches > 0}
					>
						<ResultsButton
							showCopy={
	...
	return (
		<>
			<div data-component="tool-title">
				...
				<span
					data-slot="target"
					title={props.state.input?.filePath}
				>
					{filePath()}
				</span>
			</div>
			<div data-component="tool-result">
				<Switch>
					...
					<Match
						when={
							typeof props.state.metadata?.preview !== 'string' && props.state.output
						}
					>
						<ResultsButton>
							<ContentText
...
function TaskTool(props: ToolProps) {
	return (
		<>
			...
			<ResultsButton
				showCopy="Show output"
				hideCopy="Hide output"
			>
